...
return [
    ...
    'use-sandbox' => env("TOKEN_PAGSEGURO_DEBUG", true),
    ...
    'credentials' => [//INFORME AS CREDENCIAIS PADRÕES DE SUA LOJA, MAS PORDERÁ SER ALTERADA EM RUNTIME
        ...
        'token' => (env("TOKEN_PAGSEGURO_DEBUG", true) ? env("TOKEN_PAGSEGURO_DEV", "") : env("TOKEN_PAGSEGURO_PRD", "")),
    ],
    ...
    'routes' => [
        ...
        'notification' => [
            'callback' => ['App\Http\Controllers\NotificacaoPSController', 'notificationInfo'], // Callable callback to Notification function (notificationInfo) : void {}
